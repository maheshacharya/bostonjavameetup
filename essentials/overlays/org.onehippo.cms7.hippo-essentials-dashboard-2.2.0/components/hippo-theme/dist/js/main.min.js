...
function(){"use strict";angular.module("hippo.theme").directive("hippoMap",[function(){return{restrict:"A",replace:!0,scope:{markers:"="},link:function(a,b){function c(){a.$watch("markers",function(a){var b=a.map(function(a){return new google.maps.LatLng(a.latitude,a.longitude)});d(b)})}function d(a){var b=a.map(function(a){return new google.maps.Marker({position:a})});h.clearMarkers(),h.addMarkers(b),h.redraw();
// map viewpoint based on all markers
var c=new google.maps.LatLngBounds;if(angular.forEach(a,function(a){c.extend(a)}),c.getNorthEast().equals(c.getSouthWest())){var d=new google.maps.LatLng(c.getNorthEast().lat()+.015,c.getNorthEast().lng()+.015),e=new google.maps.LatLng(c.getNorthEast().lat()-.015,c.getNorthEast().lng()-.015);c.extend(d),c.extend(e)}
//  fit these bounds to the map
g.fitBounds(c)}
// map options
var e=new google.maps.LatLng(52.359448,4.901317),f={zoom:8,mapTypeId:google.maps.MapTypeId.ROADMAP,center:e},g=new google.maps.Map(b[0],f),h=new MarkerClusterer(g,[]);angular.isArray(a.markers)?c():console.warn("map markers are not an array, but:",a.markers)}}}])}(),/*
 * Copyright 2014-2015 Hippo B.V. (http://www.onehippo.com)
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
